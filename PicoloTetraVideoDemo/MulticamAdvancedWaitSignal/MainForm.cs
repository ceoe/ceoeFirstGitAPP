...
namespace MulticamAdvancedWaitSignal
{
    /// <summary>
    ...
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        private Boolean m_RunLoop = false; 
        ...
        public MainForm()
        {
            ...
            MessageBox.Show(@"
                This program demonstrates Multicam Advanced Acquisition Mode using Wait Signal on an Euresys Board.
                
                The Go! menu starts an acquisition sequence by activating the channel.
                By default, this program requires an area-scan camera connected on connector A.", "Sample program description", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "MainForm";
            this.Text = "MulticamAdvancedWaitSignal";
        ...
        private void MainForm_Load(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                MC.SetParam(channel, MC.SignalHandling + MC.SIG_SURFACE_FILLED, MC.SIGNALHANDLING_WAITING_SIGNALING);
                MC.SetParam(channel, MC.SignalHandling + MC.SIG_ACQUISITION_FAILURE, MC.SIGNALHANDLING_WAITING_SIGNALING);
                MC.SetParam(channel, MC.SignalHandling + MC.SIG_END_CHANNEL_ACTIVITY, MC.SIGNALHANDLING_WAITING_SIGNALING);
